...
export const LanguageProvider = ({ children }: LanguageProviderProps) => {
  ...
  const translations: Record<string, Record<string, string>> = {
    ...
    hi: {
      ...
      possibleSideEffects: '⚠️ संभावित साइड इफेक्ट्स:',
      nausea: 'मतली',
      dizziness: 'चक्कर आना',
    ...
    te: {
      ...
      profile: 'ప్రొఫైల్',
      prescriptions: 'ప্রিস্క্রিপ্షন্লు',
      exercises: 'వ్యాయామాలు',
      labTests: 'ল্যাব্ টెস্ট্‌లు',
      reminders: 'রিমైন্ডர্লు',
      welcome: 'తిরిগి স্বাগতম্',
      basicInformation: 'ప্রাথমিক సమాచારం',
      medicalInformation: 'వైద్య సమাচారం',
      name: 'పేরు',
      age: 'వయస్సు',
      gender: 'లింగం',
      preferredLanguage: 'ఇష్టపడే భాష',
      currentCondition: 'ప্রবর্তমান স্থিতি',
      treatingPhysician: 'మీ చికిৎসక',
      lastVisit: 'చివరి దర্শন',
      nextAppointment: 'తదుపరి అపాయింట్‌মెంట్',
      rajeshKumar: 'రাজেশ్ కুমార్',
      years58: '৫৮ বছর',
      male: 'పুরుষుడు',
      hindi: 'हिন্দি',
      postOpKneeRecovery: 'మోకాలి శস্ত্রচিকিৎস తর্বাত পুনরুদ্ধার',
      drPriyaSharma: 'డాక্టর్ প্রিয়া শর্মা'
    }
  };
